...
app.post('/characters' ,[
    ...
    body('talent').isLength({min:3}).withMessage('Talent is required with min 3 chars')
...
app.put('/characters/:id' , [
    ...
    if(!errors.isEmpty()){
        ...
        return res.render('edit-character',{character , errors:errors.array()});

    }

    try{

        const character = await Char.findByIdAndUpdate(req.params.id , req.body, {new:true});
